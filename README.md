<table border="0">
  <tr>
    <th width="300px">
      <img src="https://media.tenor.com/y-cCxl8uEw0AAAAM/yetopen.gif" alt="penguin typing on keyboard" width="100%" />
    </th>
    <th align="left">
      <h1>👋 Hi, I'm Chris!</h1>
      <h3>"What was invented by a human mind can be unraveled by another human mind"</h3>
      <h4>- Yuri Knorozov</h4>
    </th>
  </tr>
</table>
...
<h4 align="center">DROP TABLE DROP TABLE DROP TABLE DROP TABLE DROP TABLE DROP TABLE DROP TABLE DROP TABLE DROP TABLE DROP TABLE</h4>
